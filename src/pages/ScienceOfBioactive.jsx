        ...
        <div className="flex flex-col w-full bg-brand-black text-brand-ivory font-julius">
            ...
            <section className="relative min-h-[80vh] flex flex-col items-center justify-center px-6 py-20 overflow-hidden text-center">
                ...
                <div className="z-10 max-w-2xl space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-playfair leading-tight tracking-widest uppercase">
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="group space-y-4">
                            ...
                            <h3 className="text-xl font-playfair tracking-wide text-brand-ivory">Targeted Functionality</h3>
                        ...
                        <div className="group space-y-4">
                            ...
                            <h3 className="text-xl font-playfair tracking-wide text-brand-ivory">Clinically-Aligned Actives</h3>
                            <p className="text-sm text-brand-ivory/60 leading-relaxed">
                        ...
                        <div className="group space-y-4">
                            ...
                            <h3 className="text-xl font-playfair tracking-wide text-brand-ivory">Performance Stability</h3>
                            <p className="text-sm text-brand-ivory/60 leading-relaxed">
                ...
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="p-8 border border-brand-bronze/20 bg-brand-black hover:border-brand-bronze/50 transition-colors h-full">
                            <div className="mb-6">
                                <h3 className="text-lg tracking-widest uppercase font-playfair text-brand-ivory mb-2">The Base System</h3>
                        ...
                        <div className="p-8 border border-brand-bronze/20 bg-brand-black hover:border-brand-bronze/50 transition-colors h-full">
                            <div className="mb-6">
                                <h3 className="text-lg tracking-widest uppercase font-playfair text-brand-ivory mb-2">The Fortification System</h3>
                        ...
                        <div className="p-8 border border-brand-bronze/20 bg-brand-black hover:border-brand-bronze/50 transition-colors h-full">
                            <div className="mb-6">
                                <h3 className="text-lg tracking-widest uppercase font-playfair text-brand-ivory mb-2">The Regeneration System</h3>
