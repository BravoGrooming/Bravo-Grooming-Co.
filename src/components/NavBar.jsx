        ...
        <div className="flex flex-col w-full sticky top-0 z-50">
            ...
            <nav className="bg-brand-black border-b border-brand-bronze/20 p-6 transition-all duration-300">
                <div className="container mx-auto flex items-center justify-between md:justify-start">
                    ...
                    <div className="ml-auto flex items-center gap-6 relative z-50">
                        ...
                        <button
                            className="md:hidden text-brand-ivory hover:text-brand-bronze"
                ...
                {/* Mobile Menu Overlay */}
                {isMenuOpen && (
                    <div className="absolute top-[100%] left-0 w-full bg-brand-black border-b border-brand-bronze/20 md:hidden flex flex-col items-center py-8 gap-8 font-julius text-brand-ivory text-sm tracking-[0.2em] font-bold uppercase z-40 shadow-2xl">
                        <Link to="/our-story" className="hover:text-brand-bronze transition-colors flex w-full justify-center" onClick={() => setIsMenuOpen(false)}>Our Story</Link>
                        <Link to="/product" className="hover:text-brand-bronze transition-colors flex w-full justify-center" onClick={() => setIsMenuOpen(false)}>Shop</Link>
                        <Link to="/science-of-bioactive" className="hover:text-brand-bronze transition-colors flex w-full justify-center" onClick={() => setIsMenuOpen(false)}>Science</Link>
                        <Link to="/signup" className="hover:text-brand-bronze transition-colors flex w-full justify-center" onClick={() => setIsMenuOpen(false)}>Join</Link>
                    </div>
                )}
            </nav>
        </div>
